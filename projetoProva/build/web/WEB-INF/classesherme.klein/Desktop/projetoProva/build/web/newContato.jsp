<%-- 
    Document   : newContato
    Created on : 26 de mar. de 2025, 20:41:58
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form action="newContatosdb" method="post" id="formulario">
                <div class="mb-3">
                    <label for="nome" class="form-label">Nome</label>
                    <input type="text" class="form-control ml-2" placeholder="nome" aria-label="nome" name="nome" id="nome">
                    <span class="erro" id="erro-nome"></span>
                </div>
                
                <div class="mb-3">
                    <label for="telefone" class="form-label">Telefone</label>
                    <input type="text" class="form-control ml-2" placeholder="(00) 00000-0000" name="telefone" aria-label="telefone"  id="telefone">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control ml-2" placeholder="email" name="email" aria-label="email"  id="email">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control ml-2" placeholder="000.000.000-00" name="cpf" aria-label="cpf"  id="cpf">
